            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-6">
                    <div class="logo my-3 my-sm-0">
                        <a href="index.php">
                            <img src="../assets/img/profiles/img-14.jpg" alt="ELMS Logo" class="img-fluid" width="100">
                        </a>
                    </div>
                </div>
                <!-- User Info Section -->
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="user-notification-block align-right d-inline-block">
                                    <ul class="list-inline m-0">
                                        <li class="list-inline-item" data-toggle="tooltip" data-placement="top" title="" data-original-title="Apply Leave">
                                            <a href="leave.php" class="font-23 menu-style text-white align-middle">
                                ...
                                <div class="user-info align-right dropdown d-inline-block header-dropdown">
                                    <a href="javascript:void(0)" data-toggle="dropdown" class="menu-style dropdown-toggle">
                                        <div class="user-avatar d-inline-block position-relative">
                                            <img src="../assets/img/profiles/img-14.jpg" alt="user avatar" class="rounded-circle img-fluid" width="55">
                                            <!-- Badge -->
