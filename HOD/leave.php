												...
												<table class="table custom-table mb-0">
													...
													<tbody>
														...
														while ($row1 = mysqli_fetch_assoc($result1)) {
															...
															$sql = "SELECT * FROM leaves WHERE studentrollnumber='$userroll' LIMIT $offset, $limit";
														...
														?>
															<tr>
																...
																<form action="redirect/leaveupdate.php?studentrollnumber=<?php echo $userroll; ?>" method="POST">
																	<td>
