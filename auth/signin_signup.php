   ...
   <body>
      ...
      <svg class="login__blob" viewBox="0 0 566 840" xmlns="http://www.w3.org/2000/svg">
         ...
         <g mask="url(#mask0)">
            ...
            <image class="login__img" href="../assets/assets1/img/bg-img.jpg"/>
         </g>
      </svg>      
               ...
               <div class="login__social">
                  ...
                  <div class="login__social-links">
                     <a href="#" class="login__social-link">
                        <img src="../assets/assets1/img/icon-google.svg" alt="image" class="login__social-img">
                     </a>
      
                     <a href="#" class="login__social-link">
                        <img src="../assets/assets1/img/icon-facebook.svg" alt="image" class="login__social-img">
                     </a>
      
                     <a href="#" class="login__social-link">
                        <img src="../assets/assets1/img/icon-apple.svg" alt="image" class="login__social-img">
                     </a>
                  </div>
               </div>
